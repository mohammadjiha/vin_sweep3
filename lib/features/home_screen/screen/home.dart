    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: SpeedDial(
          ...
          animatedIcon:
              isDilalOpen ? AnimatedIcons.menu_close : AnimatedIcons.add_event,
          ...
          openCloseDial: ValueNotifier(isDilalOpen),
          onOpen: () => setState(() => isDilalOpen = true),
          onClose: () => setState(() => isDilalOpen = false),
          children: [
            SpeedDialChild(
              label: 'Upload',
      ...
      floatingActionButtonLocation: CustomFloatingActionButtonLocation(
        ...
        yOffset: isDilalOpen == false ? 5.h : -6.h,
      ),
